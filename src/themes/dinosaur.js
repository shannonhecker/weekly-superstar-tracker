const dinosaur = {
  ...
  petStates: [
    ...
    { min: 21, max: 32, face: '🦕', mood: 'Getting Big!', bg: '#E8EAF6', msg: 'STOMP STOMP!' },
    { min: 33, max: 42, face: '🦖', mood: 'T-REX Mode!', bg: '#E3F2FD', msg: 'ROARRR!' },
    { min: 43, max: 70, face: '👑', mood: 'DINO KING!', bg: '#FFF3E0', msg: 'RULER OF ALL!' },
  ],
