const football = {
  ...
  petStates: [
    ...
    { min: 21, max: 32, face: '⚽', mood: 'Match Ready', bg: '#E8F5E9', msg: 'Playing great!' },
    { min: 33, max: 42, face: '🥅', mood: 'Scoring Goals!', bg: '#E3F2FD', msg: 'What a player!' },
    { min: 43, max: 70, face: '🏆', mood: 'CHAMPION!', bg: '#FFF3E0', msg: "BALLON D'OR!" },
  ],
