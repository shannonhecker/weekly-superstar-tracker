  ...
  return (
    <Modal open={open} onClose={onClose} title={`${kid?.name || 'Your'}'s week recap`} emoji="🎉">
      ...
      <button
        ...
        className="w-full py-3 rounded-pill font-bold hover:bg-earthy-cocoaDark shadow-earthy-soft active:scale-[0.98] transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-earthy-terracotta"
      >
        Yay!
      </button>
      {onOpenCollection && (
