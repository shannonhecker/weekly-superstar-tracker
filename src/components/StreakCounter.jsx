...
export default function StreakCounter({ kid }) {
  ...
  return (
    <div
      className="rounded-2xl p-3 flex items-center gap-3 h-full bg-earthy-ivory shadow-earthy-soft font-jakarta"
      style={{
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="text-sm font-extrabold text-earthy-cocoa" key={`label-${pulseKey}`}>
