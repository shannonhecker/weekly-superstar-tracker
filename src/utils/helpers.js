...
export function getBadge(score, theme) {
  ...
  if (score >= 45) return { icon: bi.diamond, label: 'Diamond', color: '#B388FF', glow: '#B388FF55' }
  if (score >= 35) return { icon: bi.gold, label: 'Gold', color: '#FFD700', glow: '#FFD70055' }
  if (score >= 25) return { icon: bi.silver, label: 'Silver', color: '#C0C0C0', glow: '#C0C0C055' }
